...
use DarkStyle\Notification\EmailOrderNotifier;
use DarkStyle\Order\IblockOrderRepository;
...
try {
    ...
    if ($action === 'order') {
        if (isset($_SESSION['DARKSTYLE_LAST_ORDER']) && time() - (int) $_SESSION['DARKSTYLE_LAST_ORDER'] < 10) {
        ...
        $_SESSION['DARKSTYLE_LAST_ORDER'] = time();
